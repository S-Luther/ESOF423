...
function displayFile(dl){
  if(counter>0){
    document.getElementById("files").innerHTML = document.getElementById("files").innerHTML + "<a href=\"image.html?file="+dl+"\"><img src=\"" + dl + "\" style=\"width:25%; height:30vh;\" onerror=\"this.onerror=null;this.src='../images/default.jpg';\"></a>"
  }counter++;
}
...
function gohome(){
  window.location = "profile.html?id="+localStorage.getItem("id");
}
